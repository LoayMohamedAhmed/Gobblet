...
class AI(tk.Label):
    def __init__(self, master,parameters = (2,("assets\\player.png" ,"assets\\player.png"))):
        tk.Frame.__init__(self, master)
        self.game = ai_game.AIGame('w', 'b',parameters[0])
        self.master = master
        self.mode ="AI_mode"
        self.p1_img_dir =parameters[1][0]
        self.p2_img_dir =parameters[1][1]
        ...
        self.player1_image = ImageLabel(self,image_path= parameters[1][0],size=(200,300), position= (0.82,0.4))
        self.player2_image = ImageLabel(self,image_path= "assets\\robot win.png",size=(200,300), position= (0.18,0.4))
